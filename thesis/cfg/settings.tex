...
\newcommand{\appsection}[2]{% #1 - Буква (А, Б..), #2 - Название
	...
	% === ПЕРЕНЕСЕНО В САМЫЙ КОНЕЦ ===
	\phantomsection % Создаем правильный якорь для ссылок hyperref
	\protected@edef\@currentlabel{#1}% Жестко прописываем букву приложения для \label
}
\makeatother

\usepackage{float}

\input{cfg/setup/enum}
\input{cfg/setup/toc}
\input{cfg/setup/biblio}
\input{cfg/setup/listings}
